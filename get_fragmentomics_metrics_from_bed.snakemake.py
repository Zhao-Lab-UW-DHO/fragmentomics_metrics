# static paths
SAMPLES_PATH = "files/samples.txt"
ATAC = "files/TCGA_ATAC_peak.all.probeMap.simple.hg38.bed"
TFBS = "files/Homo_sapiens_meta_clusters_hg38_midpoint_top5k_sorted.bed.gz"

# REPLACE WITH YOUR OWN PATH
GENOME = "/mnt/Data01/genome/hg38.fa"
